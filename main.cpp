...
void drawUI(int privilege, string userName) {
    ...
    if (privilege == 0) {
        ...
        text(32, 22, "Quit(Esc)", CFC_Gray, CBC_Black);
...
void drawUIAnimation(int privilege, string userName) {
    ...
    if (privilege == 0) {
        ...
        textAnimation(32, 22, "Quit(Esc)", CFC_Gray, CBC_Black);
...
int main() {
    ...
    SetConsoleTitle("SiriusNEO BookStore");
    system("color 0E");
        ...
        if (privilege == 0) {
            ...
            while (tempC != 13 && tempC != 27) {
                ...
                if (posY == 16) {
                    ...
                    text(32, 16, "Login", CFC_Green, CBC_Black);
                    text(32, 19, "Register", CFC_Green, CBC_Black);
                    text(32, 22, "Quit(Esc)", CFC_Gray, CBC_Yellow);
                }
                tempC = getch();
            }
            if (tempC == 27)break;// Esc for quit
